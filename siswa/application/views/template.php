...
<html>
    ...
    <body>
        ...
        <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
            <div class="profile-sidebar">
                <div class="profile-userpic">
                    ...
                    if ($this->session->userdata('level') == 1) {
                        echo "<img src=" . base_url() . "uploads/admin/admin.png class='img-responsive' alt=''>";
                ...
                <div class="profile-usertitle">
                    ...
                    <div class="profile-usertitle-status"><span class="indicator label-success"></span>Universitas Ibrahimy</div>
                </div>
                <div class="clear"></div>
            </div>
            ...
            <ul class="nav menu">
                <?php if ($this->session->userdata('level') == 1) { ?>
                    ...
                    <li><?php echo anchor('Admin/Mahasiswa', '<em class="fa fa-calendar">&nbsp;</em>Data Mahasiswa'); ?></li>
                    <li><?php echo anchor('Admin/Dosen', '<em class="fa fa-bar-chart">&nbsp;</em>Data Dosen'); ?></li>
                    <li><?php echo anchor('Admin/Fasilitas', '<em class="fa fa-toggle-off">&nbsp;</em>Akses Fasilitas'); ?></li>
                    <li><?php echo anchor('Admin/Penilaian', '<em class="fa fa-clone">&nbsp;</em>Penilaian'); ?></li>
                    <li><?php echo anchor('Admin/History', '<em class="fa fa-clone">&nbsp;</em>Dosen Persemester'); ?></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">ANGKET KEPUASAN MAHASISWA</h1>
                </div>
            </div><!--/.row-->
                    ...
                    <div class="col-xs-6 col-md-3 col-lg-3 no-padding">
                        <div class="panel panel-red panel-widget ">
                            <div class="row no-padding"><em class="fa fa-xl fa-deaf color-red"></em>
                                ...
                                ?>
                                <div class="text-muted">BOBOT FASILITAS</div>
                            </div>
                        </div>
                    </div>
                </div><!--/.row-->
        ...
        <div class="col-sm-12">
            <p class="back-link">UNIVERSITAS IBRAHIMY<a href="https://www.Tutorkomputer.com"> TI 2020</a></p>
        </div>
    </div><!--/.row-->
</div>	<!--/.main-->
